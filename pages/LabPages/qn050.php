...
<body>
  <div>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <a class="navbar-brand" href="../../index.html"><img src="./img/logo.png" class="mx-auto d-block" width="auto" height="40" ></a>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../../ProgrammingLanguage.html">Java</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="../../javaLabWork.html">Java Lab Work</a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <div class="mainContent">
    <h4>QN050. Write a program to print 'helloworld' in java</h4>
    <hr>
    <h5>1. Objective</h5>
    <p>
    ...
    <h5>2. Theory</h5>
    <p>
     <?php echo "Php is running in github"; ?>
      <br>
      System.out.print();
      <br>
    ...
    <h5>3. Source Code</h5>
    <code>
    public class Qn001{ <br>
      public static void main(String[] args){ <br>
        System.out.print("helloworld"); <br>
      } <br>
    }
    </code>
    <h5>4. Output</h5>
